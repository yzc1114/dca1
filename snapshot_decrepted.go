...
//}
//
//func doAppProcess(ctx context.Context, selfProcessID ProcessID, chanPairs map[ProcessID]*ChanPair, recorderChan chan *RecorderMsg, shouldStartSnapshot func(processID ProcessID, processStatus ProcessStatus) bool) {
//	processStatus := 0
...
//		go doAppProcess(ctx, pid, cps, recorderChan, shouldStartSnapshot)
//	}
//
